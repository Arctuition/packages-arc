...
abstract class TestWebSettingsHostApi {
  ...
  static void setup(TestWebSettingsHostApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.webview_flutter_android.WebSettingsHostApi.setCacheMode', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, null);
      } else {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.webview_flutter_android.WebSettingsHostApi.setCacheMode was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_instanceId = (args[0] as int?);
          assert(arg_instanceId != null,
              'Argument for dev.flutter.pigeon.webview_flutter_android.WebSettingsHostApi.setCacheMode was null, expected non-null int.');
          final int? arg_mode = (args[1] as int?);
          assert(arg_mode != null,
              'Argument for dev.flutter.pigeon.webview_flutter_android.WebSettingsHostApi.setCacheMode was null, expected non-null int.');
          api.setCacheMode(arg_instanceId!, arg_mode!);
          return <Object?>[];
        });
      }
    }
