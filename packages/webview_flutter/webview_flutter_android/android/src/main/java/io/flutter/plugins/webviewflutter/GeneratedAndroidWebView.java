...
public class GeneratedAndroidWebView {
  ...
  public interface WebSettingsHostApi {
    ...
    void setCacheMode(@NonNull Long instanceId, @NonNull Long mode);
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable WebSettingsHostApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.webview_flutter_android.WebSettingsHostApi.setCacheMode", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                try {
                  api.setCacheMode((instanceIdArg == null) ? null : instanceIdArg.longValue(), (modeArg == null) ? null : modeArg.longValue());
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
